...
class Translations$help$en {
	...
	/// en: 'Switch between grid and list view from Settings to browse your statuses.'
	String get switch_view_body => 'Switch between grid and list view from Settings to browse your statuses.';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'help.switch_view_body' => 'Switch between grid and list view from Settings to browse your statuses.',
			...
			'help.faq_duplicates_a' => 'Sometimes files may look duplicated because multiple contacts posted or shared the same status. The app saves each copy it receives, so you\'ll see several identical entries even though they come from the same content. You can remove unwanted copies from the Saved tab.',
